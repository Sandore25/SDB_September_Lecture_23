...
! Promises
  ...
  3 Main States
    ...
    Is an Object tat may produce a singular value in the future.
...
// console.log(data); //* We get an undefined because the ino is delayed when it is compiled.
...
/* 
! Resolvers
  - When return, the returnData() function will return a Promise instead of a given string>
...
returnData()
  ...
  * The Process
    ...
    - use resolvers (.then()/.catch()) with cb to extrapolate the info from that promise.
  */
