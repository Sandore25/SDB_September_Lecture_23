...
// Declaration: declaring the variable but no assigning it.
let x;
...
let firstName = "Eli"; //string datatype
let lastName = "Sandore"; 
...
console.log(fullName); // Eli sandore
console.log(2+2); // 4
...
today = "Super!";
// javaScript = "Meh."; //TypeError: Assignment to constant variable. Const can't be reassigned.
