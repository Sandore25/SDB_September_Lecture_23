...
/* 
    Undefined
    - No value is assigned adn doesn't act like an empty container.
*/
...
/* 
    String
        -stings are datatypes to represent text.
...
console.log(first)  // 1801, the sum of 1234 + 567 
console.log(second) // 123456, combined both sides of the '+'


//typeof: will tell you the type of data you are working with. Can check the datatype of a variable/item
...
/* 
    ...
    - Inside the object, we use key value pairs
        key: value<--- multiple key value pairs need to be separated with a comma
*/
