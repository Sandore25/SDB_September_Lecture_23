/* 
    ...
    - arrow functions (or fat arrow functions)we introduced in ES6. They are basically just a more concise way to write function expressions - NOT declarations
        - Do NOT get hoisted.
*/
...
const newName = capitalizeName('elI');
console.log(newName);
