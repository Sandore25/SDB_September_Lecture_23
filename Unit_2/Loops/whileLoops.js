...
while (n <= 10) {
    ...
    n++;
    console.log(`n after the addition, end of the loop: ${n}`);
    console.log("-----------")
}
...
while (structure != "empty street") {
    console.log(`Spide Man wings from the  ${structure} in pursuit of the thief!`);
    pos++;
    structure = city[pos];
    console.log(`Spidey lands on the ${structure}.`);
    console.log("---")
}

console.log(`Spider lands in the ${structure}! He corners and confronts the thief. Spidey saves the day again!!`)
...
do {
    ...
    // Activationg message and set acct to true
    console.log(`Acctivationg......`);
    ...
    // after acct is activated true, add 1 acctNum variable to move to the next one
    acctNum++;
} while (accounts[`acct${acctNum}`] == false )

// process complete message
console.log("All accounts are active")
console.table(accounts); // used .table()